...
export default function DesignSyatem() {
    const designSystem = [{
        ...
        links: [
            ...
            {
                "title": "How design tokens empower multi-brand design systems - Louis Chenais 🟢 Live at Into Design Systems",
        ...
        links: [
            ...
            {
                "title": "How a small team built figma.com’s design system",
            ...
            {
                "title": "Mesh Design System—A Way Forward For Design At Meesho",
